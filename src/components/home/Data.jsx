...
const Data = () => {
  return (
   <div className="home__data">
        ...
        <h3 className="home__subtitle">Machine Learning Engineer | Data Scientist | Software Enginner
        </h3>
        <p className="home__description">I am a skilled software engineer based in Dallas, with a deep passion for crafting robust and efficient solutions. </p>
        <a href="mailto:yashvib1631@gmail.com" className="button button--flex">
            Get In Touch
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
